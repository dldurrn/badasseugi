...
export const SPELLING_BANK: SpellingQuestion[] = [
  ...
  },
  {
    ...
    options: ['되', '돼'],
    answer: '되',
    explanation: '뒤에 말이 이어질 때는 "되"를 써요.',
    tag: '되/돼',
  },
  ...
  },
  {
    ...
    options: ['안', '않'],
    answer: '않',
    explanation: '"-지 않다"처럼 앞말에 붙을 때는 "않"이에요.',
    tag: '안/않',
  },
  ...
  },
  {
    ...
    options: ['곰곰이', '곰곰히'],
    answer: '곰곰이',
    explanation: '이렇게 겹쳐 쓰인 낱말 뒤에는 "-이"를 붙여요.',
    tag: '표기',
  },
  {
    id: 'ililee-1',
  ...
  /* ---------------- 틀린 곳 찾기 ---------------- */
  {
    ...
    answer: '가써요.',
    correction: '갔어요.',
    explanation: '"갔어요"로 써야 해요. 받침 ㅆ 뒤에 "어요"가 붙어요.',
    tag: '받침',
  },
  {
    id: 'find-2',
  ...
  },
  {
    ...
    answer: '유난이',
    correction: '유난히',
    explanation: '"유난히"로 써요. 부사는 대부분 "-히"로 끝나요.',
    tag: '표기',
  },
  {
    id: 'find-14',
