...
const MESSAGE: Record<FallbackNote['reason'], { title: string; body: string }> = {
  ...
  /*
    ...
    **원인은 짐작해서 적지 않습니다.** 예전 문구는 「무료 한도를 넘겨 쓴 것 같아요」였는데,
    실제로 타입캐스트가 막혔을 때 사용량은 15,000자 중 834자였고
    원인은 공급자의 「IP당 무료 계정 1개」 정책이었습니다. 틀린 원인을 믿으면
    엉뚱한 곳(사용량)을 들여다보게 됩니다. 확인할 곳만 짚어 줍니다.
  */
  blocked: {
    title: '음성 서비스가 사용을 막았어요',
    body: '기다린다고 풀리지는 않아요. 음성 서비스 계정(요금제·키)을 확인하거나 다른 음성 서비스로 바꿔야 해요.',
  },
  failed: {
