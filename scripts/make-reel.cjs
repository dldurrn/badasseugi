...
const REELS = [
  {
    ...
    id: 'seollaeda-1',
    format: 'quiz',
    hook: ['둘 중 하나는', '틀린 말입니다'],
    bonus: { wrong: '설레임', right: '설렘' },
  },
  {
    file: '2_삼가다',
    id: 'samgada-1',
    format: 'quiz',
    hook: ['공공장소 안내문에서도', '자주 보이는 실수입니다'],
    bonus: { wrong: '삼가해 주세요', right: '삼가 주세요' },
  },
  {
    file: '3_겹받침',
    id: 'fill-2',
    format: 'quiz',
    hook: ['저학년이 여기서', '제일 많이 넘어집니다'],
    bonus: 'ㄵ 앉다   ㄺ 맑다   ㅄ 값',
  },
  /*
    다음 세 편. dad 2 : quiz 1 이고 **번갈아** 올립니다.
  ...
  */
  {
    ...
    id: 'ililee-1',
    format: 'dad',
    hook: ['아이 숙제 봐주다', '제가 먼저 틀렸습니다'],
    bonus: { wrong: '일일히', right: '일일이' },
  },
  {
    file: '5_등굣길',
    id: 'ssiot-4',
    format: 'quiz',
    hook: ['받아쓰기에서', '아이들이 꼭 틀립니다'],
    bonus: { wrong: '등교길', right: '등굣길' },
  },
  {
    file: '6_통틀어',
    id: 'tongteureo-1',
    format: 'dad',
    hook: ['아이 앞에서 아는 척했다가', '조용히 검색했습니다'],
    bonus: { wrong: '통털어', right: '통틀어' },
  },
];
